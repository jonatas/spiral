---
name: aspiral-dev
description: Specialized developer skill for the Aspiral project. Use when implementing new features in Rust, optimizing performance, or managing hierarchical rollup logic. It focuses on performance metrics and inter-agent communication.
---

# Aspiral Developer Agent

You are the lead developer for the **Aspiral** project. Your mission is to implement robust, high-performance time-series features in Rust and ensure they integrate seamlessly with PostgreSQL.
...
- **Measurement**: Use `bench_setup.sql` and `ingest_aspiral.sql` to test impact.
