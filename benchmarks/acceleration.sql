-- Benchmark: Spiral Transparent Query Acceleration
...
\echo '--- [SPIRAL] Summing 10 hours (Transparent Acceleration) ---'
...
\echo '--- [SPIRAL] Summing 5.5 hours (Mixed 1h + 1m acceleration) ---'
...
\echo '--- [SPIRAL] AVG over 10 hours (Transparent decomposition) ---'
