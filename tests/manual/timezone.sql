-- Spiral Timezone-Aware Acceleration Test
...
SELECT spiral_register_view('tz_test_1h', 'tz_test_1m', 3600, 'tz_test', ARRAY[]::text[]);
SELECT spiral_register_view('tz_test_1d', 'tz_test_1h', 86400, 'tz_test', ARRAY[]::text[]);
