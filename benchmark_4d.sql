...
SELECT * FROM logs_4d
WHERE aspiral_zorder(EXTRACT(EPOCH FROM (t AT TIME ZONE 'UTC'))::bigint, ARRAY[org_id, user_id, region_id]::integer[])
      BETWEEN aspiral_zorder(EXTRACT(EPOCH FROM ('2026-04-16 10:00:00'::timestamptz AT TIME ZONE 'UTC'))::bigint, ARRAY[0, 0, 5]::integer[])
          AND aspiral_zorder(EXTRACT(EPOCH FROM ('2026-04-16 11:00:00'::timestamptz AT TIME ZONE 'UTC'))::bigint, ARRAY[50, 50, 5]::integer[]);
